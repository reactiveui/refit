        ...
        var generatedFactoryRegistrations = string.Join(
            ...
            model.Interfaces
                ...
                .Select(static interfaceModel =>
                    $"                        global::Refit.RestService.RegisterGeneratedFactory(typeof({interfaceModel.InterfaceDisplayName}), static (client, requestBuilder) => new global::Refit.Implementation.Generated.{interfaceModel.Ns}{interfaceModel.ClassSuffix}(client, requestBuilder));"
                )
        );
