...
[SuppressMessage(
    ...
    Justification = "Generic type ImmutableEquatableArray<T> kept in a dedicated file; backtick file names are avoided.")]
    ...
    where T : IEquatable<T>
{
    ...
    public ImmutableEquatableArray(IEnumerable<T> values) => _values = [.. values];
