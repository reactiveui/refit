...
public sealed partial class ResponseTests
{
    ...
    /// <summary>Case-sensitive serializer options shared by the alias mapping fixture.</summary>
    private static readonly JsonSerializerOptions _caseSensitiveSerializerOptions =
