...
namespace Refit.Implementation
{
        ...
        : global::RefitGeneratorTest.IGeneratedInterface
    {
        ...
        public global::System.Threading.Tasks.Task<string> Get()
        {
            ...
            #endif
            global::Refit.GeneratedRequestRunner.AddConfiguredRequestOptions(______rq, ______settings, typeof(global::RefitGeneratorTest.IGeneratedInterface));
        ...
        global::System.Threading.Tasks.Task<string> global::RefitGeneratorTest.IBaseInterface.GetPosts()
        {
            ...
            var ______basePath = this.Client.BaseAddress?.AbsolutePath ?? throw new global::System.InvalidOperationException("BaseAddress must be set on the HttpClient instance");
            ______basePath = ______basePath == "/" ? string.Empty : ______basePath.TrimEnd('/');
            var ______rq = new global::System.Net.Http.HttpRequestMessage(global::System.Net.Http.HttpMethod.Get, new global::System.Uri(______basePath + "/posts", global::System.UriKind.Relative));
            #if NET6_0_OR_GREATER
            ______rq.Version = ______settings.Version;
            ______rq.VersionPolicy = ______settings.VersionPolicy;
            #endif
