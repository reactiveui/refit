    ...
    internal partial class GeneratedCompilation
    {
            ...
            : global::RefitGeneratorTest.IGeneratedClient
        {
            ...
            public global::System.Threading.Tasks.Task<string> Get(int? @id)
            {
                ...
                var refitRequest = new global::System.Net.Http.HttpRequestMessage(
                    ...
                    global::Refit.GeneratedRequestRunner.BuildRelativeUri(
                        ...
                        global::Refit.GeneratedRequestRunner.BuildRequestPath(
                            ...
                            [((7, 11), refitUseDefaultFormatting ? (@id == null ? null : global::Refit.GeneratedRequestRunner.FormatInvariant(@id.Value, "00")) : global::Refit.GeneratedRequestRunner.FormatUrlParameter(refitSettings, @id, ______idAttributeProvider, typeof(int?)))]),
                ...
                global::Refit.GeneratedRequestRunner.AddRequestProperty<string>(refitRequest, global::Refit.HttpRequestMessageOptions.RelativePathTemplate, "/todos/{id}");
                if (refitSettings.CaptureMethodArguments) { global::Refit.GeneratedRequestRunner.AddRequestProperty<object?[]>(refitRequest, global::Refit.HttpRequestMessageOptions.MethodArguments, new object?[] { @id }); }
