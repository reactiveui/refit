...
/// <summary>Response DTO whose properties exercise AliasAs vs JsonProperty aliasing during deserialization.</summary>
public class TestAliasObject
{
    ...
    /// <summary>Gets or sets the value mapped via JSON property name attributes (which do affect response deserialization).</summary>
