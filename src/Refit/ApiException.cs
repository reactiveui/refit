...
[SuppressMessage("Design", "CA1032", Justification = "The shipped exception contract requires request, response and serializer context; standard constructors would fabricate that context.")]
