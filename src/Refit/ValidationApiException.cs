...
[SuppressMessage(
    "Design",
    "CA1032",
    Justification = "The shipped context-free constructors require a validation message; a parameterless constructor would supply neither a message nor HTTP context.")]
