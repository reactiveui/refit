...
sealed class GeneratedFactoryApiClient(HttpClient client, IRequestBuilder builder)
...
public class RestServiceIntegrationTests
{
    ...
    [Test]
    public void UsesRegisteredGeneratedFactory()
    {
        ...
        var generated = Assert.IsType<GeneratedFactoryApiClient>(instance);

        Assert.Same(client, generated.Client);
        Assert.NotNull(generated.Builder);
    }
