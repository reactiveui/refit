...
public class ReflectionRequestBuildingBenchmarks
{
    ...
    public void Setup()
    {
        ...
        _objectPathArgs =
        [
            new ReflectionQueryModel { Id = ReflectionBenchmarkFixtures.SampleModelId, Name = "widgets", Page = ReflectionBenchmarkFixtures.SamplePage, Inner = new() { Code = "abc", Label = "l" }, },
        ];
        _scalarQueryArgs = ["widgets", ReflectionBenchmarkFixtures.SamplePage, true];
        _bodyArgs =
        [
            new ReflectionUserModel { Id = ReflectionBenchmarkFixtures.SampleBodyUserId, Name = "octocat", Email = "octo@example.test", },
        ];
    }
