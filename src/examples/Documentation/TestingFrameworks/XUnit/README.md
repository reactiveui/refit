# Testing a Refit client with xUnit v3

Run from `src/`: `dotnet test examples/Documentation/TestingFrameworks/XUnit/XUnitTests.csproj`.

The same scenarios exist, unchanged, for [NUnit](../NUnit), [MSTest](../MSTest) and [TUnit](../TUnit) — only the
