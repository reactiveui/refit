# Testing a Refit client with TUnit

Run from `src/`: `dotnet test examples/Documentation/TestingFrameworks/TUnit/TUnitTests.csproj`.

The same scenarios exist, unchanged, for [xUnit v3](../XUnit), [NUnit](../NUnit) and [MSTest](../MSTest) — only
