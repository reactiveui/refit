...
/// <summary>Represents an API controller that provides endpoints for managing and retrieving values.</summary>
...
public class ValuesController : ControllerBase
{
    ...
    /// <summary>Updates the resource identified by the specified ID with the provided data.</summary>
