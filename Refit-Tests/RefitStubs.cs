...
namespace Refit.Tests
{
    ...
    [Preserve]
    public partial class AutoGeneratedIAnotherApi : IAnotherApi
    {
        public HttpClient Client { get; protected set; }
        readonly Dictionary<string, Func<HttpClient, object[], object>> methodImpls;

        public AutoGeneratedIAnotherApi(HttpClient client, IRequestBuilder requestBuilder)
        {
            methodImpls = requestBuilder.InterfaceHttpMethods.ToDictionary(k => k, v => requestBuilder.BuildRestResultFuncForMethod(v));
            Client = client;
        }

        public virtual Task FooBar(TypeConflict user)
        {
            var arguments = new object[] { user };
            return (Task) methodImpls["FooBar"](Client, arguments);
        }
...
namespace Refit.Tests
{
    ...
    [Preserve]
    public partial class AutoGeneratedIConflictingUser : IConflictingUser
    {
        public HttpClient Client { get; protected set; }
        readonly Dictionary<string, Func<HttpClient, object[], object>> methodImpls;

        public AutoGeneratedIConflictingUser(HttpClient client, IRequestBuilder requestBuilder)
        {
            methodImpls = requestBuilder.InterfaceHttpMethods.ToDictionary(k => k, v => requestBuilder.BuildRestResultFuncForMethod(v));
            Client = client;
        }
