...
namespace Refit.Tests
{
    ...
    /// <inheritdoc />
    [Preserve]
    public partial class AutoGeneratedIActionParameterTest : IActionOrFuncParameterTest
    {
        /// <inheritdoc />
        ...
        public virtual Task<HttpResponseMessage> Get(ActionOrFuncOptions options)
        {
            ...
            var func = methodImpls.GetOrAdd("Get(ActionParameterTestOptions options)", _ => requestBuilder.BuildRestResultFuncForMethod("Get", new Type[] { typeof(ActionOrFuncOptions) }));
        ...
        {
            var arguments = new object[] { options };
            var func = methodImpls.GetOrAdd("Get(Action<ActionParameterTestOptions> options)", _ => requestBuilder.BuildRestResultFuncForMethod("Get", new Type[] { typeof(Action<ActionOrFuncOptions>) }));
            return (Task<HttpResponseMessage>)func(Client, arguments);
        }
        ...
        public virtual Task<HttpResponseMessage> Get(Func<ActionOrFuncOptions> builder)
        {
            ...
            var func = methodImpls.GetOrAdd("Get(Func<ActionParameterTestOptions> builder)", _ => requestBuilder.BuildRestResultFuncForMethod("Get", new Type[] { typeof(Func<ActionOrFuncOptions>) }));
            return (Task<HttpResponseMessage>)func(Client, arguments);
        }
