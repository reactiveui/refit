...
namespace Refit.Tests
{
    ...
    [Preserve]
    [global::System.Reflection.Obfuscation(Exclude=true)]
    partial class AutoGeneratedIHaveDims : IHaveDims
    {
        /// <inheritdoc />
        public HttpClient Client { get; protected set; }
        readonly IRequestBuilder requestBuilder;
        ...
        /// <inheritdoc />
        public AutoGeneratedIHaveDims(HttpClient client, IRequestBuilder requestBuilder)
        {
            Client = client;
            this.requestBuilder = requestBuilder;
        }
        ...
        /// <inheritdoc />
        Task<string> IHaveDims.GetInternal()
        {
            var arguments = new object[] {  };
            var func = requestBuilder.BuildRestResultFuncForMethod("GetInternal", new Type[] {  });
            return (Task<string>)func(Client, arguments);
        }
    }
}
