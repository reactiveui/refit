...
namespace Refit.Tests
{
    ...
    [Preserve]
    public partial class AutoGeneratedDefaultOn404Api : DefaultOn404Api
    {
        public HttpClient Client { get; protected set; }
        readonly Dictionary<string, Func<HttpClient, object[], object>> methodImpls;

        public AutoGeneratedDefaultOn404Api(HttpClient client, IRequestBuilder requestBuilder)
        {
        ...
        public virtual Task<object> GetObjectAsync()
        {
            ...
            return (Task<object>) methodImpls["GetObjectAsync"](Client, arguments);
        }

        public virtual Task<int> GetInt32Async()
        {
            var arguments = new object[] {  };
            return (Task<int>) methodImpls["GetInt32Async"](Client, arguments);
        }
