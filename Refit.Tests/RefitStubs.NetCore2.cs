...
namespace Refit.Tests
{
    ...
    /// <inheritdoc />
    [Preserve]
    public partial class AutoGeneratedAliasAsResponseTestsIMyAliasService : AliasAsResponseTests.IMyAliasService
    {
        /// <inheritdoc />
        public HttpClient Client { get; protected set; }
        readonly ConcurrentDictionary<string, Func<HttpClient, object[], object>> methodImpls = new ConcurrentDictionary<string, Func<HttpClient, object[], object>>();
        ...
        public AutoGeneratedAliasAsResponseTestsIMyAliasService(HttpClient client, IRequestBuilder requestBuilder)
        {
            Client = client;
            this.requestBuilder = requestBuilder;
        }
