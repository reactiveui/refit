...
namespace Refit.Tests
{
    ...
    /// <inheritdoc />
    [Preserve]
    public partial class AutoGeneratedResponseTestsIMyAliasService : ResponseTests.IMyAliasService
    {
        /// <inheritdoc />
        public HttpClient Client { get; protected set; }
        readonly ConcurrentDictionary<string, Func<HttpClient, object[], object>> methodImpls = new ConcurrentDictionary<string, Func<HttpClient, object[], object>>();
        ...
        {
            var arguments = new object[] {  };
            var func = methodImpls.GetOrAdd("GetTestObject()", _ => requestBuilder.BuildRestResultFuncForMethod("GetTestObject", new Type[] {  }));
...
namespace AutoGeneratedIServiceWithoutNamespace
{
    ...
    partial class AutoGeneratedIServiceWithoutNamespace : IServiceWithoutNamespace
    {
        ...
        {
            var arguments = new object[] {  };
            var func = methodImpls.GetOrAdd("GetRoot()", _ => requestBuilder.BuildRestResultFuncForMethod("GetRoot", new Type[] {  }));
            return (Task)func(Client, arguments);
        }
        ...
        {
            var arguments = new object[] {  };
            var func = methodImpls.GetOrAdd("PostRoot()", _ => requestBuilder.BuildRestResultFuncForMethod("PostRoot", new Type[] {  }));
            return (Task)func(Client, arguments);
        }
