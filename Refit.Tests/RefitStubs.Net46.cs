...
namespace Refit.Tests
{
    ...
    /// <inheritdoc />
    [Preserve]
    public partial class AutoGeneratedIActionParameterTest : IActionParameterTest
    {
        /// <inheritdoc />
        ...
        public AutoGeneratedIActionParameterTest(HttpClient client, IRequestBuilder requestBuilder)
        {
            Client = client;
        ...
        /// <inheritdoc />
        public virtual Task<HttpResponseMessage> Get(ActionParameterTestOptions options)
        {
            var arguments = new object[] { options };
            var func = methodImpls.GetOrAdd("Get(ActionParameterTestOptions options)", _ => requestBuilder.BuildRestResultFuncForMethod("Get", new Type[] { typeof(ActionParameterTestOptions) }));
            return (Task<HttpResponseMessage>)func(Client, arguments);
        }

        /// <inheritdoc />
        public virtual Task<HttpResponseMessage> Get(Action<ActionParameterTestOptions> options)
        {
            var arguments = new object[] { options };
            var func = methodImpls.GetOrAdd("Get(Action<ActionParameterTestOptions> options)", _ => requestBuilder.BuildRestResultFuncForMethod("Get", new Type[] { typeof(Action<ActionParameterTestOptions>) }));
            return (Task<HttpResponseMessage>)func(Client, arguments);
        }

        /// <inheritdoc />
        public virtual Task<HttpResponseMessage> Get(Func<ActionParameterTestOptions> builder)
        {
            var arguments = new object[] { builder };
            var func = methodImpls.GetOrAdd("Get(Func<ActionParameterTestOptions> builder)", _ => requestBuilder.BuildRestResultFuncForMethod("Get", new Type[] { typeof(Func<ActionParameterTestOptions>) }));
            return (Task<HttpResponseMessage>)func(Client, arguments);
        }
